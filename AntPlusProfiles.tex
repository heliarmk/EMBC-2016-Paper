...
\hyphenation{Time-stamp Ca-pa-bi-li-ties Sa-tu-ra-ted He-mo-glo-bin stop-ped}
...
\begin{tikzpicture}[ every annotation/.style = {draw,
  ...
  \path[mindmap,concept color=black!40,text=white,
    ...
    level 2 concept/.append style={font=\bfseries,level distance=9em, minimum width=4em},
    level 3 concept/.append style={font=\bfseries,level distance=14em, minimum width=5em},
  ]
